  ...
  return (
    <div className="app">
      ...
      {/* .app-body is the split-view container (desktop/tablet, >=32rem) —
          .app-main flexes against the docked AgentChat panel across the
          grabber between them, continuously down to 0 on either side (see
          .agent-chat-splitter in App.css). Below 32rem this is inert
          (mobile keeps document-level scrolling, AgentChat stays a fixed
          overlay — see App.css). */}
